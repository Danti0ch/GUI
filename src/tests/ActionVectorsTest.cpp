...
ActionVectorsRender::ActionVectorsRender():gglib::GraphicSpace(WINDOW_WIDTH, WINDOW_HEIGHT),
    butt_reset_(40, 180, 140, 230,  gglib::Text("reset"), gglib::Color(252, 29, 170)),
    butt_speed_(160, 180, 260, 230, gglib::Text("magic"), gglib::Color(254, 6, 43)),
    butt_exit_(280, 180, 380, 230,  gglib::Text("exit"),  gglib::Color(78, 101, 202)),
    cts1_(10, 210, 510, 710, -10, 10, -10, 10),
    time_cts_group_({
        gglib::CoordinateSus(460, 560, 320, 420, -10, 10, -10, 10),
        gglib::CoordinateSus(580, 680, 320, 420, -10, 10, -10, 10),
        gglib::CoordinateSus(700, 800, 320, 420, -10, 10, -10, 10)
    }),
